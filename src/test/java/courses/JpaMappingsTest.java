...
public class JpaMappingsTest {
	...
	@Test
	public void sshouldSaveAndLoadCourse() {
	...
	@Test 
	public void shouldFindCoursesForOneParticularTopic() {
		Topic java = topicRepo.save(new Topic("java")); 
		...
		Course adanvacedJava2 = courseRepo.save(new Course("Adv Java", "Description")); 
	...
	@Test 
	public void shouldFindCoursesForTopidId() {
		Topic ruby = topicRepo.save(new Topic("Ruby")); 
